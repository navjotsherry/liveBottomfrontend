...
const AddClient = ({ setOpen, open, currentId, setCurrentId }) => {
  ...
  useEffect(() => {
    var checkId = user?.result?.sub
    const updatedClientData = { ...clientData, userId: checkId }
    setClientData(updatedClientData)
    console.log(updatedClientData.userId)
  ...
  // const clear = () => {
  //   setCurrentId(null)
  //   setClientData({ name: '', email: '', phone: '', address: '', userId: [checkId] })
  // }
          ...
          <DialogContent dividers>
            ...
            <div className="customInputs">
              ...
              <input
                ...
                name='a22'
                type='text'
                onChange={(e) => setClientData({ ...clientData, userId : e.target.value })}
