  ...
  return (
    ...
    return (
        <div className={styles.PageLayout}>
           {invoice?.creator?.includes(user?.result?.sub || user?.result?.googleId) && (
      ...
      <Table className={classes.table} aria-label="simple table">
        ...
        <TableBody>
          {invoiceData?.items?.map((itemField, index) => (
            <TableRow key={index}>
              <TableCell  scope="row" style={{width: '20%' }}> <InputBase style={{width: '100%'}} outline="none" sx={{ ml: 1, flex: 1 }} type="text" name="truckNumber" value={itemField.truckNumber} placeholder="Item name or description" readOnly /> </TableCell>
              <TableCell  scope="row" style={{width: '20%' }}> <InputBase style={{width: '100%'}} outline="none" sx={{ ml: 1, flex: 1 }} type="text" name="ticketNumber" value={itemField.ticketNumber} placeholder="Item name or description" readOnly /> </TableCell>
              <TableCell  scope="row" style={{width: '30%' }}> <InputBase style={{width: '100%'}} outline="none" sx={{ ml: 1, flex: 1 }} type="text" name="hauledFrom" value={itemField.hauledFrom} placeholder="Item name or description" readOnly /> </TableCell>
              <TableCell  scope="row" style={{width: '30%' }}> <InputBase style={{width: '100%'}} outline="none" sx={{ ml: 1, flex: 1 }} type="text" name="hauledTo" value={itemField.hauledTo} placeholder="Item name or description" readOnly /> </TableCell>
              ...
              <TableCell align="right" style={{width: '50%' }}> <InputBase sx={{ ml: 1, flex: 1 }} type="number" name="amount"  value={((itemField?.quantity * itemField.unitPrice) - (itemField.quantity * itemField.unitPrice) * itemField.discount / 100).toFixed(2)} readOnly /> </TableCell>
